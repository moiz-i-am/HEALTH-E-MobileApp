...
class DoctorProfile extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      rating: 0,
      picture:
        'https://cdn0.iconfinder.com/data/icons/user-pictures/100/unknown2-512....',
      open: false,
      success: false,
    }
  }
  ...
  handleCancel = () =>
    this.setState({ success: false, confirmIsVisible: false })
      ...
      <ScrollView>
        <Overlay
          ...
          <View>
            ...
            <Overlay
              ...
              height={550}>
              <View>
                <Text style={styles.confirmModalHeader}>
                  Appointment Details
                </Text>
        ...
        <View style={styles.mainView}>
          ...
          <Text style={styles.description}>
            ...
            accumsan lacus vel facilisis orem ipsum dolor sit amet, consectetur
            adipiscing.
          </Text>

...
import { TouchableOpacity, View, Text, StyleSheet, Button, Vibration, Platform } from 'react-native';
...
class PendingBookingListItem extends Component {
    ...
    registerForPushNotificationsAsync = async () => {
      ...
      componentDidMount() {
        ...
        body = `${" With: " + this.props.doctor+" At: " + this.props.timeSlot + "\n please visit website to call doctor"}`;
      ...
      pushNotification = () => {
        sendPushNotification(this.state.expoPushToken, `${" With: " + this.props.doctor+" At: " + this.props.timeSlot + "\n please visit website to call doctor"}`)
      }
